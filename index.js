...
// BEGIN QUALTRICS - 8/4 slider
var qualtricsNode = document.createElement('div');
qualtricsNode.setAttribute('id', 'SI_0IJaHbLKjNbGaPj');
...
try{(new g(100,"r","QSI_S_SI_0IJaHbLKjNbGaPj","//zn0ombvsv6b6ofgif-ucsf.siteintercept.qualtrics.com/WRSiteInterceptEngine/?Q_SIID=SI_0IJaHbLKjNbGaPj&Q_LOC="+encodeURIComponent(window.location.href))).start()}catch(i){}})();
// END QUALTRICS 
